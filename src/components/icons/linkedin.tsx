...
export interface LinkedinProps extends React.SVGProps<SVGSVGElement> {
  /**
   * If true, uses LinkedIn blue (#0b67c3) as the fill color. If false, uses currentColor.
   * @default false
   */
  brandColor?: boolean;
}
...
function LinkedinComponent(
  { brandColor = false, ...props }: LinkedinProps,
  ref: React.Ref<SVGSVGElement>,
) {
  return (
    <svg fill="none" ref={ref} viewBox="-3.5 0 19 19" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        ...
        fill={brandColor ? '#0b67c3' : 'currentColor'}
      />
    </svg>
  );
}
export const Linkedin = React.forwardRef(LinkedinComponent);
